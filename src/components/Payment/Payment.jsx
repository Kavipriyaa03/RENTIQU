...
import './Payment.css';  // Make sure to update the path to the new CSS file
...
const Payment = () => {
  ...
  return (
    ...
    >
      <form onSubmit={validateForm} className="payment-form">
          ...
          <div className="payment-col">
            ...
            <div className="payment-inputBox">
              ...
              <input 
                ...
                required 
              />
              {errors.name && <div className="payment-error"><FontAwesomeIcon icon={faInfoCircle} /> {errors.name}</div>}
            </div>
            <div className="payment-inputBox">
              <span>Email :</span>
              <input 
            ...
            <div className="payment-inputBox">
              ...
              />
              {errors.phone && <div className="payment-error"><FontAwesomeIcon icon={faInfoCircle} /> {errors.phone}</div>}
            </div>
          </div>
          <div className="payment-col">
            ...
            <div className="payment-inputBox">
              ...
              <input
                ...
                required
              />
              {errors.number && <div className="payment-error"><FontAwesomeIcon icon={faInfoCircle} /> {errors.number}</div>}
            </div>
            <div className="payment-inputBox">
              <span>Exp Month :</span>
              <input
                ...
                required
              />
              {errors.expiryMonth && <div className="payment-error"><FontAwesomeIcon icon={faInfoCircle} /> {errors.expiryMonth}</div>}
            </div>
            <div className="payment-inputBox">
              <span>Exp Year :</span>
              <input
                ...
                required
              />
              {errors.expiryYear && <div className="payment-error"><FontAwesomeIcon icon={faInfoCircle} /> {errors.expiryYear}</div>}
            </div>
            <div className="payment-inputBox">
              <span>CVV :</span>
              <input
                ...
                required
              />
              {errors.cvc && <div className="payment-error"><FontAwesomeIcon icon={faInfoCircle} /> {errors.cvc}</div>}
            </div>
            <div className="payment-inputBox">
              <span>UPI ID :</span>
              <input
                ...
                required
              />
              {errors.upi && <div className="payment-error"><FontAwesomeIcon icon={faInfoCircle} /> {errors.upi}</div>}
            </div>
          </div>
        </div>
        <input type="submit" value="Place Order" className="payment-submit-btn" />
      </form>
    </div>
  );
};
