...
const CircleCards = () => {
  const steps = [
    { icon: <GiAmpleDress />, title: 'Malar', description: 'The product quality is very good. I am satisfied with my purchase.', rating: 5.0 },
    { icon:<GiDress/> ,title: 'Kavi', description: ' I loved the convenience of having stylish clothes delivered to my doorstep.', rating: 4.7 },
    {  icon: <FaTshirt />,title: 'Joo', description: 'The product arrived well-packaged and in perfect condition.', rating: 4.1 },
...
const renderStars = (rating) => {
  ...
  return (
    <div className="circle-cards-container">
      <center><b><para5>Reviews</para5></b></center>
